...
VERSIONFILE = "src/daemon/_version.py"
...
setuptools.setup(
    name="mender-auth-azure-iot-mendersoftware",
    version=version_string,
    license="Apache 2.0",
    author="Mendersoftware",
    author_email="contact@mender.io",
    description="A Python daemon to authorize the Mender client through Azure IoT",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/mendersoftware/mender-auth-azure-iot",
    classifiers=[
